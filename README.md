...
- **Model**: The actual data your user wants to inspect and edit
...
- The bug is immediately visible in the UI.
- It's easy to find and fix in your code.
- Getting this right isn't actually hard (two-way bindings)
